...
\begin{figure}[H] % Example image
	\center{\includegraphics[width=0.75\linewidth]{fig3}}
	\caption{\small The effects of an increase in saving rate on investment}
	\label{fig:speciation}
\end{figure}

\begin{figure}[H] % Example image
	\center{\includegraphics[width=0.55\linewidth]{fig4_1}}
	\center{\includegraphics[width=0.55\linewidth]{fig4_2}}
	\center{\includegraphics[width=0.55\linewidth]{fig4_3}}
	\center{\includegraphics[width=0.55\linewidth]{fig4_4}}
	\center{\includegraphics[width=0.55\linewidth]{fig4_5}}
...
\begin{figure}[H] % Example image
	\center{\includegraphics[width=0.5\linewidth]{fig5_1}}
	\center{\includegraphics[width=0.5\linewidth]{fig5_2}}
	\center{\includegraphics[width=0.5\linewidth]{fig5_3}}
...
\begin{figure}[H] % Example image
	\center{\includegraphics[width=0.55\linewidth]{fig6}}
	\caption{\small The effects of an increase in saving rate on consumption}
	\label{fig:speciation}
\end{figure}
